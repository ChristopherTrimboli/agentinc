...
const tokenDistribution = [
  { label: "Community & Creators", percentage: 40, color: "#8B5CF6", description: "Rewards for creators, stakers, and active participants" },
  { label: "Liquidity Pool", percentage: 25, color: "#06B6D4", description: "DEX liquidity and pump.fun launches" },
  { label: "Treasury", percentage: 15, color: "#10B981", description: "Platform development and operations" },
  { label: "Team & Advisors", percentage: 10, color: "#F59E0B", description: "Vested over 2 years with 6-month cliff" },
  { label: "Ecosystem Grants", percentage: 10, color: "#EC4899", description: "Developer incentives and partnerships" },
];

// Creator Fee Structure
const creatorFees = [
  { action: "Company Mint", fee: "2.5%", creatorShare: "50%", description: "When users mint a new AI company" },
  { action: "Agent Token Trade", fee: "1%", creatorShare: "40%", description: "Secondary market trades on pump.fun" },
  { action: "Agent Task Revenue", fee: "5%", creatorShare: "60%", description: "Revenue from AI agent services" },
  { action: "Company Acquisition", fee: "3%", creatorShare: "50%", description: "When companies are bought/sold" },
];
...
function PieChart({ data }: { data: typeof tokenDistribution }) {
  ...
  return (
    <svg viewBox="0 0 200 200" className="w-full max-w-[300px] mx-auto drop-shadow-2xl">
      {data.map((item, index) => {
      ...
      <text x="100" y="95" textAnchor="middle" className="fill-white text-xs font-bold">$AGENT</text>
      <text x="100" y="110" textAnchor="middle" className="fill-gray-400 text-[8px]">1B Supply</text>
    </svg>
  );
}
    ...
    <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-700">
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 bg-violet-500/20 border border-violet-500/50 rounded-full px-4 py-2">
          <span className="text-violet-400 font-semibold">Platform Activity</span>
        </div>
      </div>
      
      <div className="flex justify-center mb-6">
        <svg className="w-6 h-12 text-violet-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="flex items-center gap-6">
              ...
              <Link href="/tokenomics" className="text-violet-400 font-semibold">Tokenomics</Link>
            </nav>
          </div>
        </div>
      </header>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-violet-500/10 border border-violet-500/30 rounded-full px-4 py-2 mb-6">
            <span className="text-violet-400 text-sm font-medium">$AGENT Token Economics</span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            ...
            Build AI companies, earn rewards, and share in the network&apos;s success.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/30 rounded-full px-4 py-2 mb-6">
              <span className="text-emerald-400 text-sm font-medium">Creator Rewards</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Creator Fee Structure</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Creators earn ongoing royalties from their AI companies and agents. 
              Every transaction generates fees that flow back to original creators.
            </p>
          </div>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-cyan-400">{item.fee}</div>
                ...
                <div className="flex items-center gap-2 text-emerald-400">
                  ...
                  <span className="font-semibold">{item.creatorShare} goes to creator</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Fee Distribution Flow</h2>
            <p className="text-gray-400">How platform fees are distributed across the ecosystem</p>
          </div>
          <FeeFlowDiagram />
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-transparent via-cyan-950/20 to-transparent">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Staking Benefits</h2>
            <p className="text-gray-400">Lock $AGENT to earn platform rewards and governance rights</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                title: "Revenue Share",
                description: "Earn 25% of all platform fees distributed proportionally to your stake",
                icon: "💰"
              },
              {
                title: "Governance",
                description: "Vote on protocol upgrades, fee structures, and treasury allocation",
                icon: "🗳️"
              },
              {
                title: "Premium Features",
                description: "Access exclusive agent templates, priority minting, and reduced fees",
                icon: "⭐"
              },
            ].map((benefit, index) => (
              <div 
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Team and advisor tokens are locked to ensure long-term alignment</p>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-800">
                  ...
                  <th className="text-left py-4 px-4 text-gray-400 font-medium">Cliff</th>
                  <th className="text-left py-4 px-4 text-gray-400 font-medium">Vesting</th>
                  <th className="text-left py-4 px-4 text-gray-400 font-medium">TGE Unlock</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { allocation: "Community & Creators", cliff: "None", vesting: "Continuous rewards", tge: "100%" },
                  { allocation: "Liquidity Pool", cliff: "None", vesting: "Locked in DEX", tge: "100%" },
                  { allocation: "Treasury", cliff: "None", vesting: "Governance controlled", tge: "20%" },
                  { allocation: "Team & Advisors", cliff: "6 months", vesting: "24 months linear", tge: "0%" },
                  { allocation: "Ecosystem Grants", cliff: "None", vesting: "Milestone-based", tge: "10%" },
                ].map((row, index) => (
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Create your first AI company and start earning creator rewards today.
          </p>
