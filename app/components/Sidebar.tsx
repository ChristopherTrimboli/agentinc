    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-white/10">
          <Link
            href="/"
            className="group flex items-center relative h-8 overflow-hidden"
          >
            ...
            <Image
              ...
              width={32}
              height={32}
              className={`h-8 w-8 flex-shrink-0 transition-all duration-300 group-hover:scale-[1.02] ${
                isCollapsed
            ...
            <Image
              ...
              width={180}
              height={48}
              className={`h-8 w-auto flex-shrink-0 transition-all duration-300 group-hover:scale-[1.02] ${
                isCollapsed
                  ? "opacity-0 scale-90 absolute"
                  : "opacity-100 scale-100"
              }`}
        ...
        {/* Navigation */}
        <nav
          className={`flex-1 overflow-y-auto ${isCollapsed ? "px-2 py-3" : "p-3"} space-y-1`}
        >
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {active && (
                  <div
                    className={`absolute ${isCollapsed ? "left-0 top-1/2 -translate-y-1/2 w-[3px] h-8 rounded-r-full" : "left-0 top-1/2 -translate-y-1/2 w-[3px] h-7 rounded-r-full"} bg-[#6FEC06] shadow-[0_0_12px_rgba(111,236,6,0.8)]`}
                  />
                )}

                <div
                  className={`relative ${active ? "text-[#6FEC06]" : "group-hover:text-white/80"} transition-colors duration-200`}
                >
