            ...
            {isLoading ? (
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-white/40 text-sm mb-4 max-w-xs mx-auto">
                  Connect your wallet and hold {thresholdPercent}% of{" "}
                  {tokenSymbol} to join the exclusive token-holder chat.
                </p>
                <button
                  onClick={login}
              ...
              <div className="flex flex-col" style={{ height: "400px" }}>
                ...
                <div className="px-4 py-2 flex items-center gap-2 border-b border-white/5 bg-amber-500/[0.03]">
                  ...
                  <span className="text-xs text-white/40">
                    {uniqueWallets} wallet{uniqueWallets !== 1 ? "s" : ""} in
                    chat
                  </span>
                ...
                {/* Messages area */}
                <div ref={messagesContainerRef} className="flex-1 overflow-y-auto px-4 py-3 space-y-3 scroll-smooth">
                  {messages.length === 0 ? (
