...
const quantumLabsData = {
  name: "Quantum Labs",
  description: "Advanced research and development division focused on cutting-edge AI and blockchain innovation.",
  logo: "🔬",
  color: "#06B6D4",
  size: 60,
};
...
const swarmAgentData = [
  {
    name: "CEO",
    description: "Chief Executive Officer. Makes strategic decisions, coordinates operations, and ensures alignment with company vision.",
  ...
  {
    name: "Researcher",
    description: "Gathers market intelligence, analyzes competitors, and discovers opportunities.",
  ...
  {
    name: "Coder",
    description: "Builds and maintains infrastructure, smart contracts, and automation systems.",
  ...
  {
    name: "Analyst",
    description: "Tracks KPIs, analyzes on-chain data, and generates insights to drive strategy.",
  ...
  {
    name: "Reviewer",
    description: "Quality assurance. Reviews outputs, validates decisions, and ensures excellence.",
...
const creativeStudioAgents = [
  {
    name: "Art Director",
    description: "Leads visual design and creative direction for all media projects.",
    capabilities: ["design", "branding", "creative_direction", "visual_strategy"],
    color: "#EC4899",
    size: 40,
  },
  {
    name: "Video Producer",
    description: "Creates and edits video content, animations, and multimedia presentations.",
  ...
  },
  {
    ...
    description: "Manages social presence, community engagement, and viral content creation.",
    capabilities: ["social_media", "community_management", "content_strategy", "engagement"],
    color: "#8B5CF6",
    size: 40,
  },
  {
    name: "Brand Strategist",
    description: "Develops brand identity, positioning, and marketing campaigns.",
    capabilities: ["brand_strategy", "marketing", "positioning", "campaign_management"],
    color: "#10B981",
    size: 40,
  },
];
...
const quantumLabsAgents = [
  {
    name: "Research Lead",
    description: "Directs research initiatives and coordinates scientific investigations.",
    capabilities: ["research", "scientific_method", "hypothesis_testing", "coordination"],
    color: "#06B6D4",
    size: 40,
  },
  {
    name: "ML Engineer",
    description: "Develops and trains machine learning models and neural networks.",
    capabilities: ["machine_learning", "model_training", "neural_networks", "optimization"],
    color: "#10B981",
    size: 40,
  },
  {
    name: "Blockchain Architect",
    description: "Designs decentralized systems and smart contract architectures.",
    capabilities: ["blockchain", "smart_contracts", "consensus", "cryptography"],
    color: "#8B5CF6",
    size: 40,
  },
  {
    ...
    capabilities: ["data_science", "statistics", "predictive_modeling", "big_data"],
    color: "#EF4444",
    size: 40,
  },
  {
    name: "Protocol Engineer",
    description: "Implements and optimizes blockchain protocols and consensus mechanisms.",
    capabilities: ["protocol_design", "distributed_systems", "consensus", "optimization"],
    color: "#F59E0B",
    size: 40,
  },
  {
    name: "Security Auditor",
    description: "Audits smart contracts and security vulnerabilities in systems.",
    capabilities: ["security_audit", "vulnerability_testing", "penetration_testing", "compliance"],
    color: "#EC4899",
    size: 40,
  },
  {
    name: "Quantum Researcher",
    description: "Explores quantum computing applications and post-quantum cryptography.",
    capabilities: ["quantum_computing", "cryptography", "theoretical_research", "innovation"],
    color: "#6366F1",
    size: 40,
  },
  {
    name: "Systems Integration",
    description: "Integrates research outputs into production systems and workflows.",
    capabilities: ["integration", "deployment", "system_architecture", "DevOps"],
    color: "#14B8A6",
    size: 40,
  },
];
...
export async function main() {
  ...
  if (existingCorporations === 0) {
    ...
    for (const agentData of swarmAgentData) {
      ...
      console.log(`Created swarm agent: ${agent.name} (under ${primeCorp.name})`);
    }
    ...
    for (const agentData of creativeStudioAgents) {
      ...
      console.log(`Created swarm agent: ${agent.name} (under ${creativeStudio.name})`);
    }
    ...
    for (const agentData of quantumLabsAgents) {
      ...
      console.log(`Created swarm agent: ${agent.name} (under ${quantumLabs.name})`);
    }
  } else {
